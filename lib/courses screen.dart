import 'package:assignment_2/courses%20details.dart';
import 'package:flutter/material.dart';

import 'CustomCourseItem.dart';
...
class CoursesScreen extends StatelessWidget {
  ...
  List<CoursesData> cd=[
    CoursesData(
        ...
        textContainer: "Android Course",
        textDescription: '''Part 1 ( Java SE)
...
• one signal push notifications SDK'''
    ...
    CoursesData(
        ...
        textContainer: "Ios Course",
        textDescription: '''OOP refreshment
• Introduction
...
• Creating final project depends on attendees needs'''
    ...
    CoursesData(
        ...
        textContainer: "Full Stack Course",
        ...
        child: ListView.separated(
            itemBuilder: (context,index){
              return CustomCourseItem(
                image: cd[index].image,
                textContainer: cd[index].textContainer,
                goToDetails: (){
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context)=>CoursesDetails(
                              image: cd[index].image,
                              textDescription: cd[index].textDescription,
                          ),
                      )
                  );
                },
